...
public class Login_Activity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setupVariables();
            //permission write storage
            allowStoragePermission();
            allowLocationPermission();
            RequestWriteExternalStorage();

            //PEDIR PERMISSAO DE LOCALIZACAO E ATIVAR LOCALIZACAO
    ...
    public void RequestWriteExternalStorage() {
        ...
        if(EasyPermissions.hasPermissions(this, perms)) {
            ...
            EasyPermissions.requestPermissions(this, "Garantir permissão de escrita no dispositivo?", REQUEST_LOCATION_PERMISSION, perms);
        }

    }
    /*  Show Popup to access User Permission  */
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(Login_Activity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                ...
                case REQUEST_CHECK_SETTINGS:
                    switch (resultCode) {
                        case RESULT_OK:
                            ...
                            updateGPSStatus("O sinal GPS está ligado no seu dispositivo");
                            //startLocationUpdates();
                            break;
                        case RESULT_CANCELED:
                            Log.e("Settings", "Result Cancel");
                            updateGPSStatus("O sinal GPS está desligado no seu dispositivo");
                            break;
                    }
                    break;
            }
    ...
    public void postlogin(){
        ...
        StringRequest LoginstringRequest = new StringRequest(Request.Method.POST, posturl, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext(), " E-mail ou Palavra-Passe estão incorretas", Toast.LENGTH_SHORT).show();
    ...
    public void salto(){
        ...
        Intent intent = new Intent(Login_Activity.this,Scanwifi.class);
