...
public class AddPi_withmoreinfo extends AppCompatActivity {
    Button confirmar;
    EditText Nome, Coordx, Coordy;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_pi_withmoreinfo);
        ...
        Coordx.setText(PI.get_PI_Coordx_by_ID("largura"));
        Coordy.setText(PI.get_PI_Coordy_by_ID("comprimento"));
    ...
    public void postPI(){
        ...
        final String Coordxs = Coordx.getText().toString();
        final String Coordys = Coordy.getText().toString();
        //id_space
    ...
    public void salto() {
        Intent intent = new Intent(AddPi_withmoreinfo.this,InfoPI.class);
